...
class AsianBeef extends React.Component {
  state = {
    data: [],
    query: "",
    fullData: [],
  ...
  renderHeader = () => (
    <View style={styles.headerView}>
      <TextInput
        ...
        status="info"
        placeholder="Search beef products..."
    ...
    return (
      <View style={styles.renderView}>
        <View style={styles.header}>
          ...
          {/*Title Button */}
          <View>
            <Text style={styles.titleText}>Beef</Text>
          </View>
          {/*Checkout Button */}
