...
class EuroMustard extends React.Component {
  state = {
    data: [],
    query: "",
    fullData: [],
  ...
  renderHeader = () => (
    <View style={styles.headerView}>
      <TextInput
        ...
        status="info"
        placeholder="Search mustard products..."
    ...
    return (
      <View style={styles.renderView}>
        <View style={styles.header}>
          ...
          {/*Title Button */}
          <View>
            <Text style={styles.titleText}>Mustard</Text>
          </View>
          {/*Checkout Button */}
