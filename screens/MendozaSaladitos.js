...
class MendozaSaladitos extends React.Component {
  state = {
    data: [],
    query: "",
    fullData: [],
  ...
  renderHeader = () => (
    <View style={styles.headerView}>
      <TextInput
        ...
        status="info"
        placeholder="Search saladitos products..."
    ...
    return (
      <View style={styles.renderView}>
        <View style={styles.header}>
          ...
          {/*Title Button */}
          <View>
            <Text style={styles.titleText}>Saladitos</Text>
          </View>
          {/*Checkout Button */}
...
export default MendozaSaladitos;
